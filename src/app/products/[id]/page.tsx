...
import { PRODUCT_FAMILIES, WIRE_SPECS, SLEEVING_SPECS, CABLE_SPECS, TAPE_SPECS } from '../../../data/content';
  ...
  if (!family) {
    return (
      <div className="max-w-7xl mx-auto px-6 py-24 text-center space-y-4">
        <h1 className="text-2xl font-bold uppercase tracking-wider text-ink font-display">Product Family Not Found</h1>
        <p className="text-sm text-ink/60">The specified product family does not exist in our catalog database.</p>
        <Link href="/products" className="inline-block bg-ink text-paper font-mono text-xs uppercase tracking-widest px-6 py-3">
          Back to Catalog
        </Link>
      </div>
    );
